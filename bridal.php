...
$res=mysqli_query($obj->connect(),"select business_reg.reg_number, business_reg.b_title,business_reg.logo,services.price1,services.price2 from business_reg,services where business_reg.reg_number=services.b_regno and services.category='Bridal Saloons'");
